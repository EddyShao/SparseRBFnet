...
file_path_1 = 'exps/exp_bi/bilap_gaussian_outer_results/bilap_gaussian_outer_seed_200.pkl'
file_path_2 = 'exps/exp_bi/bilap_results/bilap_seed_200.pkl'
...
plt.yscale('log')
plt.legend()
plt.savefig('exps/exp_bi/bi_convergence_tics.png')
...
plt.yscale('log')
plt.legend()
plt.savefig('exps/exp_bi/bi_convergence_iter.png')