...
if __name__ == "__main__":
    # load original json
    with open("exps/exp_Eikonal_Aniso/aggregated_results.json", "r") as f:
        data = json.load(f)
    ...
    # save cleaned json
    with open("exps/exp_Eikonal_Aniso/aggregated_results_cleaned.json", "w") as f:
        json.dump(cleaned, f, indent=2)

    print("Saved cleaned results to exps/exp_Eikonal_Aniso/aggregated_results_cleaned.json")