...
# # Base directories
# EXP_DIR="exps/exp_bi_pos_29"
# LOG_DIR="logs/exp_bi_pos_29"
...
python scripts/solve_pde_aux.py --config exps/exp_bi_pos_29/bilap_matern.yaml --seed 202 --save_dir exps/exp_bi_pos_29/bilap_matern_results 