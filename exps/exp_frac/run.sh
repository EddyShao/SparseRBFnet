#!/bin/bash
echo "Starting experiment: exp_frac"
# Base directories
EXP_DIR="exps/exp_frac"
LOG_DIR="logs/exp_frac"

# Collect ALL yaml files matching frac_*.yaml EXCEPT base.yaml
YAMLS=($(ls ${EXP_DIR}/frac_*.yaml | grep -v "base.yaml"))
