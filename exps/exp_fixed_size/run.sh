...
# Base directories
EXP_DIR="exps/exp_fixed_size"
LOG_DIR="logs/exp_fixed_size"

# Collect ALL yaml files matching bilap_*.yaml EXCEPT base.yaml
YAMLS=($(ls ${EXP_DIR}/*.yaml | grep -v "base.yaml"))
...
# python scripts/solve_pde.py \
#         --config "exps/exp_fixed_size/N_2048_smooth.yaml" \
#         --seed 204 \
#         --save_dir "exps/exp_fixed_size/N_2048_smooth_results" 


python scripts/solve_pde.py \
        --config "exps/exp_fixed_size/N_2048.yaml" \
        --seed 204 \
        --save_dir "exps/exp_fixed_size/N_2048_results" 